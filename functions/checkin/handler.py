"""
Checkin commands for tournament participants
"""
...
from libs.constants import SIGNUP_SHEET, CHANNEL_IDS, COLUMNS, COLORS, CHECKED_IN_MSG
...
def handler(event: dict, context: LambdaContext) -> str:
    """Handle EventBridge events for Discord checkin commands"""
